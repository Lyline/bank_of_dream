...
public class IndexAppliGUI extends JPanel {
  ...
  public IndexAppliGUI() {
    accountSelectBtn.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        if (enterAccountNumberTextField.getText().isEmpty()) errorMessageLabel.setForeground(Color.red);
  ...
  public static void openNewWindow(Container nameWindow, String titleWindow) {
    JFrame createAccountWindow = new JFrame(titleWindow);
    createAccountWindow.setContentPane(nameWindow);
    createAccountWindow.setLocation(1400, 200);
    createAccountWindow.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
...
// DO NOT EDIT OR ADD ANY CODE HERE!
  ...
  private void $$$setupUI$$$() {
    ...
    errorMessageLabel.setForeground(new Color(-3100784));
